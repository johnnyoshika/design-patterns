...
namespace DesignPatterns.Tests.EventAggregator
{
    ...
    {
        // Commenting these 2 tests out b/c they pass individually, but fail when they run at the same time
        // due to SynchronizationContext in SimpleEventAggregator:
        // https://github.com/xunit/xunit/issues/883
        ...
        // Commenting this test b/c it fails due to SynchronizationContext in SimpleEventAggregator:
        // https://github.com/xunit/xunit/issues/883
